...
export async function run(): Promise<void> {
  try {
    ...
    let cmdKustomizeSearch: string = '/bin/bash -c "git ls-tree -r \"origin/' + BASE_BRANCH_NAME + '\" --name-only | grep -E \'(' + constants.KustomizeFiles.KustomizationYaml + '|' + constants.KustomizeFiles.KustomizationYml + ')\'"'
